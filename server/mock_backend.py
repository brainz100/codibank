...
def codistyle_generate():
    ...
    prompt = (
        ...
        "FRAMING: Full body from head to shoes. Subject fills 85-90%% of frame height. "
        "Head at top 5%% of frame, shoes at bottom 5%%. Minimal empty space above head and below feet. "
        "NO luggage, NO suitcase, NO handbag on floor, NO props beside the person. Clean minimal background. "
